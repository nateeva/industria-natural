      ...
      >
        ...
        <Box sx={style} className="rounded-md w-[90%] 2xl:w-[75%] scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar-thumb-verde-100 scrollbar-track-claro scrollbar-thin">
          <div className="flex items-center justify-between">
            <h2 className='mb-4 text-2xl font-bold text-marron-200'>Nuevo producto {dtosForm.nombre} </h2>
            <Icon
              onClick={handleClose}
          ...
          <div className="flex flex-col xl:flex-row">
            ...
            <div className="mt-4 xl:mt-0 md:mr-4 xl:w-1/2">
              <Input onChange={onInputChange} value={dtosForm.descripcion} label="Descripción" name="descripcion" textarea className="cursor-default scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar-thumb-gris-100 scrollbar-track-claro scrollbar-thin" />
            </div>
          </div>
          ...
          <div className="gap-6 mt-8 md:justify-end md:flex ">
            ...
            <Button className="w-full md:w-fit bg-verde-100 hover:bg-verde-200"
              onClick={(e) => {
